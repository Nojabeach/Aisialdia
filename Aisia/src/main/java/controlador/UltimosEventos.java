 ...
 * 
 * Este servlet proporciona la información de los últimos eventos, incluyendo el nombre y la extensión de la imagen asociada.
 * 
...
public class UltimosEventos extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			int cantidadEventos = 10; // Cantidad puesta por mi para así visualizar la barra de scroll y poder editarla correctamente
